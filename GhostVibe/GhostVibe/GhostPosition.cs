...
namespace GhostVibe
{
    class GhostPosition
    {
        ...
        {
            if (ind == 0)
                return new Vector2(Helper.Helper.ViewportWidth * 0.1f, Helper.Helper.ViewportHeight * 0.8f);
            else if (ind == 1)
                ...
                return new Vector2(Helper.Helper.ViewportWidth * 0.9f, Helper.Helper.ViewportHeight * 0.8f);
        }
    }
}
